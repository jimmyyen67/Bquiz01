		...
		<div id="ms">
			<div id="lf" style="float:left;">
				<div id="menuput" class="dbor">
					...
					<a style="color:#000; font-size:13px; text-decoration:none;" href="?do=image&p=1">
						<div class="mainmu">
							校園映象資料管理 </div>
					</a>
					...
					<a style="color:#000; font-size:13px; text-decoration:none;" href="?do=news&p=1">
						<div class="mainmu">
							最新消息資料管理 </div>
					</a>
			...
			<div class="di" style="height:540px; border:#999 1px solid; width:76.5%; margin:2px 0px 0px 0px; float:left; position:relative; left:20px;">
				...
				<?php
				$file = (empty($_GET['do'])) ? "title" : $_GET['do'];
				if (file_exists("backend/$file.php")) {
